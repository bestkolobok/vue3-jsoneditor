  ...
  plugins: [
    ...
    chunkSplitPlugin({
      ...
      customSplitting: {
        ...
        '@codemirror_autocomplete': [/@codemirror\/autocomplete/],
        '@codemirror_commands': [/@codemirror\/commands/],
        '@codemirror_lang-json': [/@codemirror\/lang-json/],
        '@codemirror_language': [/@codemirror\/language/],
        '@codemirror_lint': [/@codemirror\/lint/],
        '@codemirror_search': [/@codemirror\/search/],
        '@codemirror_state': [/@codemirror\/state/],
        '@codemirror_view': [/@codemirror\/view/],
