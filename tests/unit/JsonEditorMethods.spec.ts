...
describe('JsonEditor Event Emissions', () => {
  ...
  it('should have correct emits defined', () => {
    ...
    expect(emitNames).toContain('update:json')
    expect(emitNames).toContain('update:text')
    expect(emitNames).toContain('update:jsonString')
    expect(emitNames).toContain('update:selection')
    expect(emitNames).toContain('change')
    expect(emitNames).toContain('error')
    expect(emitNames).toContain('change-mode')
    expect(emitNames).toContain('update:mode')
    expect(emitNames).toContain('change-query-language')
    expect(emitNames).toContain('focus')
    expect(emitNames).toContain('blur')
  })
})
